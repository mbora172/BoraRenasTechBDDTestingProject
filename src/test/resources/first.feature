...
#  Once you order, you should be able to verify “Payment successfull!” text.
  ...
  @smoke-everyday(weed) @regression-everySprintMigration
  Scenario: Credit card credentials input
  ...
  @regression-everySprintMigration
  Scenario Outline: Variety quantity purchases
